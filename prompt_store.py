...
def _register_defaults():
    ...
    STORE.register(PromptSpec(
        ...
        default_template=(
            ...
            "Style: photo-realistic, broadcast lighting, sharp focus, neutral expression "
            "(this is the starting frame of a speaking clip — keep the mouth closed or "
            "barely parted). No text overlays, no watermarks, no captions."
        ),
        param_docs={
            ...
            "head_orientation": "Sentence describing the head pose (from cfg.TALKING_HEAD_ORIENTATIONS, "
                                 "or a free-form custom value entered by the user).",
        },
    ))
